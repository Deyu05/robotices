...
class Metaclass_ExploreForward_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('com2009_team69_2025')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward_Goal')
            logger.debug(
...
class Metaclass_ExploreForward_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExploreForward_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExploreForward_SendGoal_Request(metaclass=Metaclass_ExploreForward_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'com2009_team69_2025/ExploreForward_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['com2009_team69_2025', 'action'], 'ExploreForward_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from com2009_team69_2025.action._explore_forward import ExploreForward_Goal
...
class Metaclass_ExploreForward_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from com2009_team69_2025.action import _explore_forward
...
class ExploreForward_SendGoal(metaclass=Metaclass_ExploreForward_SendGoal):
    from com2009_team69_2025.action._explore_forward import ExploreForward_SendGoal_Request as Request
    from com2009_team69_2025.action._explore_forward import ExploreForward_SendGoal_Response as Response
...
class ExploreForward_GetResult_Response(metaclass=Metaclass_ExploreForward_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'com2009_team69_2025/ExploreForward_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['com2009_team69_2025', 'action'], 'ExploreForward_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from com2009_team69_2025.action._explore_forward import ExploreForward_Result
...
class Metaclass_ExploreForward_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExploreForward_GetResult(metaclass=Metaclass_ExploreForward_GetResult):
    from com2009_team69_2025.action._explore_forward import ExploreForward_GetResult_Request as Request
    from com2009_team69_2025.action._explore_forward import ExploreForward_GetResult_Response as Response
...
class Metaclass_ExploreForward_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExploreForward_FeedbackMessage(metaclass=Metaclass_ExploreForward_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'com2009_team69_2025/ExploreForward_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['com2009_team69_2025', 'action'], 'ExploreForward_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from com2009_team69_2025.action._explore_forward import ExploreForward_Feedback
...
class Metaclass_ExploreForward(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com2009_team69_2025.action.ExploreForward')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExploreForward(metaclass=Metaclass_ExploreForward):
    ...
    from com2009_team69_2025.action._explore_forward import ExploreForward_Goal as Goal
    # The result message defined in the action definition.
    from com2009_team69_2025.action._explore_forward import ExploreForward_Result as Result
    # The feedback message defined in the action definition.
    from com2009_team69_2025.action._explore_forward import ExploreForward_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from com2009_team69_2025.action._explore_forward import ExploreForward_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from com2009_team69_2025.action._explore_forward import ExploreForward_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from com2009_team69_2025.action._explore_forward import ExploreForward_FeedbackMessage as FeedbackMessage
